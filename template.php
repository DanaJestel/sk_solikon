 ...
 */
function sk_solikon_html_head_alter(&$head_elements) {
 ...
 */
function sk_solikon_process_html(&$variables) {
 ...
 */
function sk_solikon_process_page(&$variables) {
...
function sk_solikon_page_alter($page) {
...
function sk_solikon_breadcrumb($variables) {
